...
<h2 class="text-center my-4 font-sans text-xl">¿Quieres trabajar en la industria tech? Tenemos decenas de plataformas para que encuentres tu próximo empleo</h2>
